...
import { 
  ...
  Settings, Check, X, Shield, Users, Coins, Image, HelpCircle, AlertCircle, FileText, QrCode
} from 'lucide-react';
            ...
            <form onSubmit={handleSaveForm} className="flex-1 overflow-y-auto p-6 space-y-5 text-slate-700">
              ...
              {editorTab === 'info' && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[10px] font-black text-slate-500 block uppercase">Đường dẫn Logo Ban Tổ Chức (URL)</label>
                      <input
                        type="url"
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-black text-slate-500 block uppercase">Đường dẫn ảnh Banner/Nền (URL)</label>
                      <input
                        type="url"
